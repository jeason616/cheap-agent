...
ENABLE_WRITING_CACHE: bool = os.getenv("ENABLE_WRITING_CACHE", "true").lower() == "true"
WRITING_CACHE_TTL_SEC: int = _env_int("WRITING_CACHE_TTL_SEC", 600)
ENABLE_LLM_WRITING_CHECK: bool = os.getenv("ENABLE_LLM_WRITING_CHECK", "true").lower() == "true"
...
ENABLE_FIGURE_CACHE: bool = os.getenv("ENABLE_FIGURE_CACHE", "true").lower() == "true"
FIGURE_CACHE_TTL_SEC: int = _env_int("FIGURE_CACHE_TTL_SEC", 600)
ENABLE_LLM_FIGURE_CHECK: bool = os.getenv("ENABLE_LLM_FIGURE_CHECK", "true").lower() == "true"
...
ENABLE_RELATED_WORK_CACHE: bool = os.getenv("ENABLE_RELATED_WORK_CACHE", "true").lower() == "true"
RELATED_WORK_CACHE_TTL_SEC: int = _env_int("RELATED_WORK_CACHE_TTL_SEC", 600)
ENABLE_LLM_RELATED_WORK_CHECK: bool = os.getenv("ENABLE_LLM_RELATED_WORK_CHECK", "true").lower() == "true"
...
ENABLE_REBUTTAL_CACHE: bool = os.getenv("ENABLE_REBUTTAL_CACHE", "true").lower() == "true"
REBUTTAL_CACHE_TTL_SEC: int = _env_int("REBUTTAL_CACHE_TTL_SEC", 600)
ENABLE_LLM_REBUTTAL_CHECK: bool = os.getenv("ENABLE_LLM_REBUTTAL_CHECK", "true").lower() == "true"
