"""Full integration test: call all MCP tools."""
...
r = recv(10)
print(f"Init: {'OK' if r else 'FAIL'}")
...
tests = [
    ...
    (11, "read_file_around_line", {"file_path": "config.py", "line_number": 21}),
    (12, "extract_symbols", {"file_path": "config.py"}),
    ...
    (20, "generate_unit_test_plan", {"file_path": "config.py", "use_llm": False}),
    (21, "check_config_consistency", {"use_llm": False}),
    (22, "suggest_validation_plan", {"task_description": "fix bug", "changed_files": "config.py", "use_llm": False}),
    # Phase 5: Review
    ...
    (25, "post_edit_review", {"task_description": "fix bug", "changed_files": "config.py", "use_llm": False}),
    (26, "analyze_change_impact", {"task_description": "change function", "target_files": "config.py", "use_llm": False}),
    # Phase 6: Cache
    (27, "cache_status", {}),
